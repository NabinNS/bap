      ...
      >
        ...
        <div className="flex w-full lg:w-1/2 flex-col bg-white px-10 xl:px-10 pt-12 pb-12 relative">
          ...
          <div className="space-y-6 mt-16">
            ...
            <form className="flex flex-col mt-10" noValidate>
              {/* Fields */}
              ...
              <button
                type="submit"
                className="w-full rounded-xl py-3.5 text-sm font-bold text-white bg-primary hover:bg-primary/90 hover:-translate-y-0.5 active:translate-y-0 transition-all duration-150 cursor-pointer mt-8"
              >
                Sign in
              </button>
            </form>
